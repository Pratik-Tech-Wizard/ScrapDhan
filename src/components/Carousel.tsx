...
export default function Carousel({
  ...
  const handleDragEnd = (_: any, info: { offset: { x: any; }; velocity: { x: any; }; }) => {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden p-4 ${round
        ...
        : "rounded-[24px] border border-[#22c55e]"
        }`}
      style={{
        width: `${baseWidth}px`,
          ...
          return (
            <motion.div
              ...
              className={`relative shrink-0 flex flex-col ${round
                ? "items-center justify-center text-center bg-[#22c55e] border-0"
                : "items-start justify-between bg-[hsla(0,0%,13%,0)] border border-[#22c55e] rounded-[12px]"
